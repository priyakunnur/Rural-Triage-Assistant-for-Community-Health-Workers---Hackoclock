...
export const FACILITIES: Facility[] = [
  ...
  { id: "ka-hub-1", name: { en: "KIMS Hubballi", kn: "ಕಿಮ್ಸ್ ಹುಬ್ಬಳ್ಳಿ" }, type: "Hospital", phone: "9019763635", lat: 15.3628762, lng: 75.1298617, address: { en: "Vidyanagar, Hubballi", kn: "ವಿದ್ಯಾನಗರ, ಹುಬ್ಬಳ್ಳಿ" } },
  { id: "ka-dwd-1", name: { en: "SDM Medical College Hospital", kn: "ಎಸ್‌ಡಿಎಂ ಆಸ್ಪತ್ರೆ" }, type: "Hospital", phone: "0836-2477561", lat: 15.4589, lng: 75.0078, address: { en: "Sattur, Dharwad", kn: "ಧಾರವಾಡ" } },
  { id: "ka-bgm-1", name: { en: "BIMS Belagavi", kn: "ಬಿಮ್ಸ್ ಬೆಳಗಾವಿ" }, type: "Hospital", phone: "0831-2466131", lat: 15.8497, lng: 74.4977, address: { en: "Belagavi", kn: "ಬೆಳಗಾವಿ" } },
  { id: "ka-bgm-2", name: { en: "KLE Dr. Prabhakar Kore Hospital", kn: "ಕೆಎಲ್‌ಇ ಆಸ್ಪತ್ರೆ" }, type: "Hospital", phone: "0831-2473777", lat: 15.8702, lng: 74.5042, address: { en: "Nehru Nagar, Belagavi", kn: "ನೆಹರೂ ನಗರ, ಬೆಳಗಾವಿ" } },
